  ...
  return (
    <>
      ...
      <Text category={'c1'} appearance={'hint'}>
        {property.street}, {property.city}, {getStateAbbreviation(property.state)} {property.zip}
      </Text>
      <View style={styles.mapContainer}>
        <MapView
          ...
          initialRegion={{
            ...
            latitudeDelta: 0.0922, //Veritcal span of map i.e how many degree of latitude map should be shown on screen
            longitudeDelta: 0.0421, //Horizontol span of map i.e how many degree of latitude map should be shown on screen
          }}>
          <MapMarker color={theme['color-info-400']} lat={property.lat} lng={property.lng} />
        </MapView>
      </View>
      ...
      {property.scores ? (
        <FlatList
          ...
          renderItem={({ item }) => <ScoreCard score={item} style={styles.scoreCard} />}
        />
      ) : null}
    </>
  );
