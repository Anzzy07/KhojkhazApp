...
export const ManageUnitsCard = ({
  ...
  const showEditName = () => setFieldValue(`apartments[${index}].editName`, true);
  const hideEditName = () => setFieldValue(`apartments[${index}].editName`, false);
        ...
        <Row style={styles.unitNameRow}>
          {apartment.unit && !apartment.editName ? (
            <>
              ...
              <TouchableOpacity onPress={showEditName} style={styles.editNameButton}>
                <MaterialIcons name="info-outline" size={18} color={theme['color-info-500']} />
            ...
            <>
              ...
              />
              <TouchableOpacity onPress={hideEditName} style={styles.doneButton}>
