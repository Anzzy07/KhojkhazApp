      ...
      {apartments.map((i, index) => {
        return (
          <View key={index}>
            {apartments.length > 1 ? (
              <>
                {property && property.apartments && index >= property.apartments.length ? (
            ...
            <Row style={[styles.input, styles.unitRow]}>
              <Input
                ...
                onBlur={() => setFieldTouched(`apartments[${index}].leaseLength`)}
                caption={
                  touched.apartments &&
              ...
              <PressableInput
                style={styles.smallInput}
                onPress={() => setFieldValue(`apartments[${index}].showCalendar`, true)}
            ...
            <Divider style={styles.divider} />
            <TouchableOpacity onPress={() => handleShowAlternateScreen(index, AMENITIES_STR)}>
              <Text status={'info'}>Property Amenities</Text>
            </TouchableOpacity>
            <Divider style={styles.divider} />
            <TouchableOpacity onPress={() => handleShowAlternateScreen(index, DESCRIPTION_STR)}>
            ...
            <Row style={styles.toggleRow}>
              ...
              <Toggle
                ...
                onChange={(isChecked) => setFieldValue(`apartments[${index}].active`, isChecked)}
              />
            </Row>
            <Divider style={styles.divider} />
