      ...
      <Screen style={styles.container}>
        ...
        {emailSent ? (
          <>
            ...
            <Text>
              An email containing instructions about how to change your password has been sent to
              you. Please check your junk mail or spam section if you do not see an email.
            </Text>
          </>
        ) : (
          <>
            ...
            <Text>Please enter your email, and we'll send mail to change your password.</Text>
            <Formik
              initialValues={{
                email: '',
              }}
